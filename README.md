...
2. **Modèle compatible OpenAI** : Sélectionnez ou saisissez le modèle à utiliser pour les requêtes textuelles
3. **URL de l'API** : Indiquez l'URL d'un service compatible OpenAI si nécessaire (par exemple un serveur Ollama local)
